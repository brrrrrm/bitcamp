...
public class Exam01_Reflection_Parameter {
    ...
    public static void main(String[] ok) {
        Class clazz = Exam01_Reflection_Parameter.class;
        ...
        for (Method m : methods) {
            ...
            for (Parameter p : parameters) {
                ...
                // 꺼낼 수 있다.
                // > javac -d bin/main -encoding UTF-8 -parameters src/step18/ex5/Exam01.java
