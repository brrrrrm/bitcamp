...
public class Exam04_Thread_Running_CPU {
...
//컨텍스트 스위칭
//동시에 여러 개의 프로세스나 스레드를 실행할 떄 
//cpu 사용권을 빼앗아 다른 프로세스나 스레드에게 주기 전에
//현재까지 실행한 코드의 위치 정보를 저장해야 한다
//또한 cpu사용권을 주기 전에 프로세스나 스레드가 어디까지 실행했는지 위치 정보를 로딩해야 한다
//즉 실행위치에 대한 정보를 저장하고 로딩하는 것을 말한다
