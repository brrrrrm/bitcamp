...
public class ExamY_5_InstanceVariableInstanceMethod {
    public static void main(String[] args) {
        ...
        Calculator4_InstanceMethod c1 = new Calculator4_InstanceMethod(); // 식1의 계산 결과를 보관할 메모리 준비
        Calculator4_InstanceMethod c2 = new Calculator4_InstanceMethod(); // 식2의 계산 결과를 보관할 메모리 준비
