...
public class TaskController {
    ...
    @RequestMapping("/add")
    public String add(@RequestParam("teamName")String teamName, @RequestParam("memberId")String memberId, Task task) throws Exception {
    ...
    public String update(@RequestParam("teamName")String teamName, @RequestParam("memberId")String memberId, Task task) throws Exception {
