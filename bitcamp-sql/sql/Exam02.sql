...
update test1 set pstno='111', fax='222' where no = 3;
...
수동으로 처리하고싶다면 autocommit을 false로 설정하라

> set autocommit=false;

insert/update/delete를 수행한 후 승인을 해야만 실제 테이블에 적용된다
> commit;
...
insert into test1(name, tel) values('zzz', '1111');
...
delete from test1 where no=4 or no=5 or no=6;
