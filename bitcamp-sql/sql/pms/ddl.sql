...
ALTER TABLE pms2_team_member
    ADD CONSTRAINT PK_pms2_team_member -- 팀 회원 기본키
        PRIMARY KEY (
            tnm, -- 팀명
            mid  -- 아이디
        );
...
-- 팀 회원
ALTER TABLE pms2_team_member
    ADD CONSTRAINT FK_pms2_team_TO_pms2_team_member -- 팀 -> 팀 회원
        FOREIGN KEY (
            tnm -- 팀명
        )
        REFERENCES pms2_team ( -- 팀
...
-- 팀 회원
ALTER TABLE pms2_team_member
    ADD CONSTRAINT FK_pms2_member_TO_pms2_team_member -- 회원 -> 팀 회원
        FOREIGN KEY (
            mid -- 아이디
        )
        REFERENCES pms2_member ( -- 회원
