...
public interface BoardDao {
    ...
    //그러려면 메소드를 만들 때 몇 가지 규칙을 따라야 한다
    //1)맵퍼 파일의 namespace는 인터페이스의 패키지 및 인터페이스명과 같아야 한다
    //  예)bitcamp.java106.step12.ex4.BoardDao
//    <mapper namespace="BoardMapper">
//    2)메소드의 이름과 SQL아이디가 같아야 한다
//    3)메소드의 리턴 타입과 SQL맵퍼 파일의 resultType 또는 resultMap이 같아야 한다
//      insert, update, delete일 경우 리턴 값이 void 또는 int가 될 수 있다 
//    4)SQL 맵퍼는 파라미터 값을 한 개만 받기 때문에 DAO 인터페이스에서도
//      SQL맵퍼의 파라미터와 일치하는 같은 타입의 값을 한 개만 선언해야 한다
