...
<pre>
- 변수, 조건문, 반복문, URL다루기, 국제화 지원, 숫자 및 날짜 형식 변환, XML, DB연동 등 다양한 기능을 제공하는 JSP확장 태그이다.
- EL과 함께 사용하면 JSP 페이지에서 자바 코드를 최소화할 수 있다.
...
2)방법
 - mvnrepository.com 에서 JSTL 라이브러리를 찾는다
