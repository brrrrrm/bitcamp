//ServletRequestAttributeListener : 서블릿리퀘스트에 값을 저장하거나 제거할 때 발생하는 이벤트 처리 
package step09.ex2;
...
public class Listener3 implements ServletRequestAttributeListener{
    ...
    public void attributeAdded(ServletRequestAttributeEvent srae) {
        System.out.println("Listner3.attributeAdded()");
    ...
    public void attributeReplaced(ServletRequestAttributeEvent srae) {
        ...
        System.out.println("Listner3.attributeReplaced()");
